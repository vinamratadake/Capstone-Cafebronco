//
//  Salad_Bar_ViewController.swift
//  Capstone_CafeBronco
//
...
class Salad_Bar_ViewController: UIViewController {
    // item1 attributes
    ...
    // Hide number pad when user touches anywhere on screen other than text field
